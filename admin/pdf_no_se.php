...
try{
	...
	$script = "select student_registrations.*,without_south_east.study_center_code, without_south_east.study_centre_email,without_south_east.phone_number from `student_registrations` inner join `without_south_east` on `without_south_east`.`study_center_code` = `student_registrations`.`study_center_code` where `exam_session` = '".$exam_session ."' 
		and `exam_day` = '".$day ."' group by `without_south_east`.`study_center_code`, `student_registrations`.`course`";
