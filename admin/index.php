...
<head>
	...
	<link rel="icon" type="image/png" href="assets/img/login-bg/logo.png" />
        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                <div class="news-image">
									...
									<video loop="loop" autoplay="" playsinline="" muted="" id="mejs_04978300085092657_html5" preload="none" src="assets/img/login-bg/NOUN-AT-A-GLANCE-3.mov" style="margin-top: -60px; width: 1440px; height: 810px;">
										<source type="video/mp4" src="assets/img/login-bg/NOUN-AT-A-GLANCE-3.mov">
									</video>
                    <!-- <img src="assets/img/login-bg/bg-2.jpg" data-id="login-cover-image" alt="" /> -->
                </div>
                <div class="news-caption">
									<h4 class="caption-title"><img src="assets/img/login-bg/logo.png" style="height: 70px;margin-top:-5px" alt="" /> National Open University of Nigeria</h4>
            ...
            <div class="right-content">
                ...
                <div class="login-header ">
                    ...
                    <div class="brand text-inverse" style="width:650px">
                        <span class="" ></span>NOUN DEA POP APP
                ...
                <form action="login.php" method="POST">
                    ...
                    <!-- <form  method="POST" class="margin-bottom-0"> -->
                        ...
                        <div class="login-buttons">
                            <button  class="btn btn-success btn-block btn-lg" id="login" name="login">Sign me in</button>
                        </div>
                        ...
                        <hr />
                        <p class="text-center">
                            &copy; NOUN-DAE All Right Reserved 2022
                        </p>
                    <!-- </form> -->
                </div>
                <!-- end login-content -->
