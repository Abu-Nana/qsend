...
$day = "select student_registrations.id,student_registrations.exam_day from `student_registrations` group by `student_registrations`.`exam_day` order by `exam_day` asc";
