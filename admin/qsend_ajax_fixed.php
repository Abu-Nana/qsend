<?php
/**
 * Fixed AJAX Handler for Sending Questions
        ...
        try {
            ...
            if ($zip->open($zipfile, ZipArchive::CREATE | ZipArchive::OVERWRITE) === true) {
                ...
                if ($files_added > 0) {
                    ...
                    if (!empty($email)) {
                        $email_sent = sendQuestionEmail($email, $zipfile, $password, $subject, $body, $study_center);
...
/**
 * Send email with question attachment
 */
function sendQuestionEmail($email, $attachment, $password, $subject, $body, $study_center) {
    try {
